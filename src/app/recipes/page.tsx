    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-ink-muted mt-1">
          Search for recipes or create your own.
        </p>
      </div>
      ...
      <div className="border-t border-amber-light/30 pt-6">
        ...
        {showForm && (
          <form
            ...
            className="border border-amber-light/40 rounded-xl bg-cream-dark p-6 space-y-5 mb-6"
          >
            ...
            <div>
              <label className="block text-xs font-medium text-ink-light mb-2">Nutrition (per serving, optional)</label>
        ...
        {recipesWithMatch.length === 0 ? (
          <p className="text-ink-muted text-sm py-4 text-center">
            No saved recipes yet. Search above or create your own.
          </p>
        ) : (
